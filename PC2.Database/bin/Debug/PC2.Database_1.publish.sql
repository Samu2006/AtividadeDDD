...
GO
PRINT N'Creating [dbo].[VehicleSales]...';
...
GO
PRINT N'Creating [dbo].[FK_Buyer_Address]...';


GO
ALTER TABLE [dbo].[Buyer]
    ADD CONSTRAINT [FK_Buyer_Address] FOREIGN KEY ([AddressId]) REFERENCES [dbo].[Address] ([Id]);


GO
PRINT N'Creating [dbo].[FK_Vehicle_Model]...';


GO
ALTER TABLE [dbo].[Vehicle]
    ADD CONSTRAINT [FK_Vehicle_Model] FOREIGN KEY ([ModelId]) REFERENCES [dbo].[Model] ([Id]);


GO
PRINT N'Creating [dbo].[FK_VehicleSales_Vehicle]...';


GO
ALTER TABLE [dbo].[VehicleSales]
    ADD CONSTRAINT [FK_VehicleSales_Vehicle] FOREIGN KEY ([VehicleId]) REFERENCES [dbo].[Vehicle] ([Id]);


GO
PRINT N'Creating [dbo].[FK_VehicleSales_Buyer]...';


GO
ALTER TABLE [dbo].[VehicleSales]
    ADD CONSTRAINT [FK_VehicleSales_Buyer] FOREIGN KEY ([BuyerId]) REFERENCES [dbo].[Buyer] ([Id]);
